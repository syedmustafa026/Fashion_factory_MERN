![Fashion Factory](https://github.com/catherineisonline/shopping-time/blob/main/src/assets/images/project-preview.png?raw=true)

# [Fashion Factory](https://shopping-time.vercel.app/)
Fashion Factory is an e-commerce website that has at least 150 women's clothing products with different sizes and color choices. You can choose various attributes like size and color. There is a cart where you can see added items and edit, add, or remove them. You can also set a currency of your choice.
