...
const Order = ({ orderFormValue, cartItems, selectedCurrency, clearCart }) => {
    ...
    useEffect(() => {
        document.title = "Order summary | Fashion Factory";
    }, []);
    ...
    return (
        <main className="order">
            ...
            <section className="order-success">
                ...
                <p>
                    Your order has been received successfully at Fashion Factory. We're thrilled that you've chosen us for your fashion needs. Your style journey is about to begin!
                </p>
                <h3> Order Details:</h3>
